...
public final class DatapointMapWithCompression {
	...
	implements Collector<FoodComponentDatapoint, Map<SemanticIdentifier, FoodComponentDatapoint>, DatapointMapWithCompression> {
		...
		@Override public Function<Map<SemanticIdentifier, FoodComponentDatapoint>, DatapointMapWithCompression> finisher() {
			return map -> {
				...
				return new DatapointMapWithCompression(comps, data, toIndex);
			};
		}
