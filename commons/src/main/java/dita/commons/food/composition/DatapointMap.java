...
public class DatapointMap {
	...
	private final TreeMap<SemanticIdentifier, FoodComponentDatapoint> delegate = new TreeMap<>();
	...
	public FoodComponentDatapoint put(final FoodComponentDatapoint value) {
		return delegate.put(value.componentId(), value);
	}
