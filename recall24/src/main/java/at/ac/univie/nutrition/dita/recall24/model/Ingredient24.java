...
/**
 * Implements {@link at.ac.univie.nutrition.dita.recall24.api.Ingredient24} as Java record type.
 * @see Ingredient24
 */
public record Ingredient24(
        ...
        ) implements at.ac.univie.nutrition.dita.recall24.api.Ingredient24 {
