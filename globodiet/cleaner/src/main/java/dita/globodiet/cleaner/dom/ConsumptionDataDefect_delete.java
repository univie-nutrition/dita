...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this ConsumptionDataDefect",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class ConsumptionDataDefect_delete {
    @Inject
    ...
    @MemberSupport
    public ConsumptionDataDefect.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
