 ...
 *  under the License.
 */
package dita.globodiet.survey.bootstrap;
...
@PrivateDataTest
class BootstrapTest extends DitaGdSurveyIntegrationTest {

    @Test
    void init() {
        // verifies that we can bootstrap the application context for testing
    }
}
