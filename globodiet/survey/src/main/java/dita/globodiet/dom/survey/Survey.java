 ...
 * Interviewer
 */
@Named("dita.globodiet.survey.Survey")
@DomainObject
@DomainObjectLayout(
...
public class Survey implements Cloneable<Survey>, HasSecondaryKey<Survey> {
    ...
    @PropertyLayout(
            fieldSetId = "identity",
            sequence = "1",
            describedAs = "Unique Survey code",
     ...
     */
    @Named("dita.globodiet.survey.Survey.Manager")
    @DomainObjectLayout(
            describedAs = "Interviewer",
            cssClassFa = "solid users-viewfinder .survey-color"
    )
    ...
    @Named("dita.globodiet.survey.Survey.Unresolvable")
