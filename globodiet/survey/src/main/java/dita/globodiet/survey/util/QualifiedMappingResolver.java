...
public record QualifiedMappingResolver(
    ...
    private Record24.Consumption annotate(Record24.Consumption consumption) {
        //TODO[dita-globodiet-survey-24] perhaps optimize: don't process if annotation is already present 
        return nutMapping
