...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this ConsumptionDataCleaner",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class ConsumptionDataCleaner_delete {
    @Inject
    ...
    private final ConsumptionDataCleaner mixee;

    @MemberSupport
    public ConsumptionDataCleaner.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
