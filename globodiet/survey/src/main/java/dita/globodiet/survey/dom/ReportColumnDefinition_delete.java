...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this ReportColumnDefinition",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class ReportColumnDefinition_delete {
    @Inject
    ...
    @MemberSupport
    public ReportColumnDefinition.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
