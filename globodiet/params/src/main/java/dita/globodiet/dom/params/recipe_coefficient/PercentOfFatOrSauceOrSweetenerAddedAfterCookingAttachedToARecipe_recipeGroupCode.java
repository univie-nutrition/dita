...
public class PercentOfFatOrSauceOrSweetenerAddedAfterCookingAttachedToARecipe_recipeGroupCode {
    @Inject
    ...
    public RecipeGroup prop() {
        return repositoryService
            .uniqueMatch(RecipeGroup.class,
                foreign->Objects.equals(foreign.getRecipeGroupCode(), mixee.getRecipeGroupCode()))
            .orElse(null);
    }
}
