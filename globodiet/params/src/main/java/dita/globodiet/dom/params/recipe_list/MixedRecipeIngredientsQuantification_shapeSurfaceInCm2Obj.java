...
public class MixedRecipeIngredientsQuantification_shapeSurfaceInCm2Obj {
    @Inject
    ...
    public Shape prop() {
        return repositoryService
            .uniqueMatch(Shape.class,
                foreign->Objects.equals(foreign.getShapeSurfaceInCm2(), mixee.getShapeSurfaceInCm2()))
            .orElse(null);
    }
}
