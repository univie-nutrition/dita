 ...
 */
@Named("dita.globodiet.params.food_descript.FacetDescriptorPathwayForFoodGroup")
@DomainObject
@DomainObjectLayout(
...
public class FacetDescriptorPathwayForFoodGroup implements Cloneable<FacetDescriptorPathwayForFoodGroup> {
     ...
     */
    @Named("dita.globodiet.params.food_descript.FacetDescriptorPathwayForFoodGroup.Manager")
    @DomainObjectLayout(
            describedAs = "Facet/descriptor pathway for food group/subgroup.\n"
                            + "Optionally can be superseded by @{table FOODFAEX}.",
            cssClassFa = "solid right-left"
