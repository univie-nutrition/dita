...
public class PercentOfFatOrSauceOrSweetenerAddedAfterCookingAttachedToARecipe_fatGroupCodeForFSSObj {
    @Inject
    ...
    public FoodGroup prop() {
        return repositoryService
            .uniqueMatch(FoodGroup.class,
                foreign->Objects.equals(foreign.getFoodGroupCode(), mixee.getFatGroupCodeForFSS()))
            .orElse(null);
    }
}
