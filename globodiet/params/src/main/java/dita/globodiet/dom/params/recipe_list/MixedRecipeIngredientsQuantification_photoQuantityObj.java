...
public class MixedRecipeIngredientsQuantification_photoQuantityObj {
    @Inject
    ...
    public PhotoForQuantity prop() {
        return repositoryService
            .uniqueMatch(PhotoForQuantity.class,
                foreign->Objects.equals(foreign.getQuantificationStringThatDefinesTheQuantitiesOfEachPhotos(), mixee.getPhotoQuantity()))
            .orElse(null);
    }
}
