 ...
 */
@Named("dita.globodiet.params.food_descript.FacetDescriptorPathwayForFood")
@DomainObject
@DomainObjectLayout(
...
public class FacetDescriptorPathwayForFood implements Cloneable<FacetDescriptorPathwayForFood> {
    ...
    @PropertyLayout(
            fieldSetId = "details",
            sequence = "3",
            describedAs = "Order to display the facets for the attached food (same order as ORDER_FAC in @{table GROUPFAC})",
     ...
     */
    @Named("dita.globodiet.params.food_descript.FacetDescriptorPathwayForFood.Manager")
    @DomainObjectLayout(
            describedAs = "Facet/descriptor pathway for individual food.\n"
                            + "Supersedes this food's group facet/descriptor pathway from @{table GROUPFAC}."
    )
