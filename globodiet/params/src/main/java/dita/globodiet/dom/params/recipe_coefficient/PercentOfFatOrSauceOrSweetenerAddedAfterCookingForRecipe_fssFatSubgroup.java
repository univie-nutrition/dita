...
public class PercentOfFatOrSauceOrSweetenerAddedAfterCookingForRecipe_fssFatSubgroup {
    @Inject
    ...
    public FoodSubgroup prop() {
        final var lookupKey = new FoodSubgroup.SecondaryKey(mixee.getFssFatSubgroupCode(), null, null);
