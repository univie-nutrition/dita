...
public class ExceptionToFacetsPathwayForRecipe implements Cloneable<ExceptionToFacetsPathwayForRecipe> {
    @Inject
    ...
    @Programmatic
    @Override
    public ExceptionToFacetsPathwayForRecipe copy() {
        var copy = repositoryService.detachedEntity(new ExceptionToFacetsPathwayForRecipe());
    ...
    @NotPersistent
    public ExceptionToFacetsPathwayForRecipe.Manager getNavigableParent() {
        return new ExceptionToFacetsPathwayForRecipe.Manager(searchService, "");
    }
