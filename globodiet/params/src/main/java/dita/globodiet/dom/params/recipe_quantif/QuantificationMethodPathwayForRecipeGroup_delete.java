...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this QuantificationMethodPathwayForRecipeGroup",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class QuantificationMethodPathwayForRecipeGroup_delete {
    @Inject
    ...
    @MemberSupport
    public QuantificationMethodPathwayForRecipeGroup.Manager act(
