...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this SelectedParameterForDataEntry",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class SelectedParameterForDataEntry_delete {
    @Inject
    ...
    @MemberSupport
    public SelectedParameterForDataEntry.Manager act(String dependants) {
