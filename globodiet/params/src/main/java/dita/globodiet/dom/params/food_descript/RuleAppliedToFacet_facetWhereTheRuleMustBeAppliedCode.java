...
public class RuleAppliedToFacet_facetWhereTheRuleMustBeAppliedCode {
    @Inject
    ...
    public Facet prop() {
        return repositoryService
            .uniqueMatch(Facet.class,
                foreign->Objects.equals(foreign.getFacetCode(), mixee.getFacetWhereTheRuleMustBeAppliedCode()))
            .orElse(null);
    }
}
