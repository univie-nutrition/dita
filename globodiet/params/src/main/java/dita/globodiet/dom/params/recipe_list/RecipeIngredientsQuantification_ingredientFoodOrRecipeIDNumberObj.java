...
public class RecipeIngredientsQuantification_ingredientFoodOrRecipeIDNumberObj {
    @Inject
    ForeignKeyLookupService foreignKeyLookup;

    private final RecipeIngredientsQuantification mixee;
    ...
    public FoodOrProductOrAlias prop() {
        return foreignKeyLookup
            .unary(
                // local
                mixee, "ingredientFoodOrRecipeIDNumber", mixee.getIngredientFoodOrRecipeIDNumber(),
                // foreign
