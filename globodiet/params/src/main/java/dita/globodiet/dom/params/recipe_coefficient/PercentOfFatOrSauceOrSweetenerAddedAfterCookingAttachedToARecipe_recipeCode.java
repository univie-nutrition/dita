...
public class PercentOfFatOrSauceOrSweetenerAddedAfterCookingAttachedToARecipe_recipeCode {
    @Inject
    ...
    public MixedRecipeNames prop() {
        return repositoryService
            .uniqueMatch(MixedRecipeNames.class,
                foreign->Objects.equals(foreign.getRecipeIDNumber(), mixee.getRecipeCode()))
            .orElse(null);
    }
}
