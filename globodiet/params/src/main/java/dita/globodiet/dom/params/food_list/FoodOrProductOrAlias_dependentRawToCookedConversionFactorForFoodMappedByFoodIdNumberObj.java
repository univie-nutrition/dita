...
import dita.globodiet.dom.params.food_coefficient.RawToCookedConversionFactorForFood_foodIdNumberObj;
...
public class FoodOrProductOrAlias_dependentRawToCookedConversionFactorForFoodMappedByFoodIdNumberObj {
    @Inject
    ...
    public List<RawToCookedConversionFactorForFood> coll() {
        return dependantLookup.findDependants(
            ...
            RawToCookedConversionFactorForFood_foodIdNumberObj.class,
            RawToCookedConversionFactorForFood_foodIdNumberObj::prop,
            mixee);
    }
}
