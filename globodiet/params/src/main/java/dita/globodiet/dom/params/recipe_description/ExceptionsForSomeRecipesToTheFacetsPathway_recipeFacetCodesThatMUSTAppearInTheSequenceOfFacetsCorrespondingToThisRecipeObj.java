...
public class ExceptionsForSomeRecipesToTheFacetsPathway_recipeFacetCodesThatMUSTAppearInTheSequenceOfFacetsCorrespondingToThisRecipeObj {
    @Inject
    RepositoryService repositoryService;

    private final ExceptionsForSomeRecipesToTheFacetsPathway mixee;

    @MemberSupport
    public FacetForRecipe prop() {
        return repositoryService
            .uniqueMatch(FacetForRecipe.class,
                foreign->Objects.equals(foreign.getFacetCodeForRecipes(), mixee.getRecipeFacetCodesThatMUSTAppearInTheSequenceOfFacetsCorrespondingToThisRecipe()))
            .orElse(null);
    }
}
