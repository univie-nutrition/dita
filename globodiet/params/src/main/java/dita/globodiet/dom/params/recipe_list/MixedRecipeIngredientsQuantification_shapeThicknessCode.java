...
public class MixedRecipeIngredientsQuantification_shapeThicknessCode {
    @Inject
    ...
    public ThicknessForShapeMethod prop() {
        return repositoryService
            .uniqueMatch(ThicknessForShapeMethod.class,
                foreign->Objects.equals(foreign.getThicknessCode(), mixee.getShapeThicknessCode()))
            .orElse(null);
    }
}
