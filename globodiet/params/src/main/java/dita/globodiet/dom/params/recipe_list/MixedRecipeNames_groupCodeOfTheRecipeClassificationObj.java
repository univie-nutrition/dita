...
public class MixedRecipeNames_groupCodeOfTheRecipeClassificationObj {
    @Inject
    RepositoryService repositoryService;

    private final MixedRecipeNames mixee;

    @MemberSupport
    public RecipeGroup prop() {
        return repositoryService
            .uniqueMatch(RecipeGroup.class,
                foreign->Objects.equals(foreign.getRecipeGroupCode(), mixee.getGroupCodeOfTheRecipeClassification()))
            .orElse(null);
    }
}
