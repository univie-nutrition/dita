...
public class ItemDefinition implements Cloneable<ItemDefinition> {
    @Inject
    ...
    public ItemDefinition copy() {
        var copy = repositoryService.detachedEntity(new ItemDefinition());
        copy.setSequentialNumber(getSequentialNumber());
    ...
    @NotPersistent
    public ItemDefinition.Manager getNavigableParent() {
        return new ItemDefinition.Manager(searchService, "");
    }
