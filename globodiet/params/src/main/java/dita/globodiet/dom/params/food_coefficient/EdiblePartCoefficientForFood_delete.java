...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this EdiblePartCoefficientForFood",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class EdiblePartCoefficientForFood_delete {
    @Inject
    ...
    @MemberSupport
    public EdiblePartCoefficientForFood.Manager act(String dependants) {
