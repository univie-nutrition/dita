...
public class DietarySupplementList_dietarySupplementClassificationCode {
    @Inject
    ...
    public DietarySupplementClassification prop() {
        return repositoryService
            .uniqueMatch(DietarySupplementClassification.class,
                foreign->Objects.equals(foreign.getDietarySupplementClassificationCode(), mixee.getDietarySupplementClassificationCode()))
            .orElse(null);
    }
}
