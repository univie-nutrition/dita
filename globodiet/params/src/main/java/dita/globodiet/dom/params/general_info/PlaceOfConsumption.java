...
public class PlaceOfConsumption implements HasSecondaryKey<PlaceOfConsumption> {
    ...
    @PropertyLayout(
            sequence = "1",
            describedAs = "Place of consumption code<br>----<br>required=true, unique=true",
    ...
    @PropertyLayout(
            sequence = "2",
            describedAs = "Place of consumption name<br>----<br>required=true, unique=true",
            hidden = Where.NOWHERE
    )
    @Column(
            name = "POC_NAME",
    ...
    @PropertyLayout(
            sequence = "3",
            describedAs = "0=not a 'Other' place<br>1='Other' place<br>----<br>required=true, unique=false",
            hidden = Where.NOWHERE
    )
    @Column(
            name = "POC_OTHER",
     ...
     */
    @Value
    public static final class SecondaryKey implements ISecondaryKey<PlaceOfConsumption> {
