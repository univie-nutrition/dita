...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this ComposedRecipeIngredient",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class ComposedRecipeIngredient_delete {
    @Inject
    ...
    @MemberSupport
    public ComposedRecipeIngredient.Manager act(String dependants) {
