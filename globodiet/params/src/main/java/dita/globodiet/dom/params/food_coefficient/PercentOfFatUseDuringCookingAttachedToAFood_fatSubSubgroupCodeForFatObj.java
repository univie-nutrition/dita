...
public class PercentOfFatUseDuringCookingAttachedToAFood_fatSubSubgroupCodeForFatObj {
    @Inject
    RepositoryService repositoryService;

    private final PercentOfFatUseDuringCookingAttachedToAFood mixee;

    @MemberSupport
    public FoodSubgroup prop() {
        return repositoryService
            .uniqueMatch(FoodSubgroup.class,
                foreign->Objects.equals(foreign.getFoodSubSubgroupCode(), mixee.getFatSubSubgroupCodeForFat()))
            .orElse(null);
    }
}
