...
public class ProbingQuestionPathwayForRecipes_probingQuestionCode {
    @Inject
    ...
    public ProbingQuestions prop() {
        return repositoryService
            .uniqueMatch(ProbingQuestions.class,
                foreign->Objects.equals(foreign.getProbingQuestionCode(), mixee.getProbingQuestionCode()))
            .orElse(null);
    }
}
