...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this ImprobableSequenceOfFacetAndDescriptor",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class ImprobableSequenceOfFacetAndDescriptor_delete {
    @Inject
    ...
    @MemberSupport
    public ImprobableSequenceOfFacetAndDescriptor.Manager act(String dependants) {
