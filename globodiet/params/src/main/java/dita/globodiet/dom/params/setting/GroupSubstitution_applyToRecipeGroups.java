...
public class GroupSubstitution_applyToRecipeGroups {
    @Inject
    ...
    @MemberSupport
    public Can<RecipeGrouping> coll() {
        return foreignKeyLookup.decodeLookupKeyList(RecipeGrouping.class, mixee.getApplyToRecipeGroupsLookupKey())
