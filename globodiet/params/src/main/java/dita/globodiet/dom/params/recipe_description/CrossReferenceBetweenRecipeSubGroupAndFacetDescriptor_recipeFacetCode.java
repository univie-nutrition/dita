...
public class CrossReferenceBetweenRecipeSubGroupAndFacetDescriptor_recipeFacetCode {
    @Inject
    ...
    public FacetForRecipe prop() {
        return repositoryService
            .uniqueMatch(FacetForRecipe.class,
                foreign->Objects.equals(foreign.getFacetCodeForRecipes(), mixee.getRecipeFacetCode()))
            .orElse(null);
    }
}
