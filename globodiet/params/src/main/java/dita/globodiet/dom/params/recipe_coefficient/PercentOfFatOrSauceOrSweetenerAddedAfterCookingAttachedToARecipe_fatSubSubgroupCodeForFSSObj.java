...
public class PercentOfFatOrSauceOrSweetenerAddedAfterCookingAttachedToARecipe_fatSubSubgroupCodeForFSSObj {
    @Inject
    ...
    public FoodSubgroup prop() {
        return foreignKeyLookup
            .unary(
                // local
                mixee, "fatSubSubgroupCodeForFSS", mixee.getFatSubSubgroupCodeForFSS(),
                // foreign
