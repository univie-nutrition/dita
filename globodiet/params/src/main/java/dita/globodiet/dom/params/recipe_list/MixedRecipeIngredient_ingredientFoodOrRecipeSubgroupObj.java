...
public class MixedRecipeIngredient_ingredientFoodOrRecipeSubgroupObj {
    @Inject
    ...
    public FoodSubgroup prop() {
        return repositoryService
            .uniqueMatch(FoodSubgroup.class,
                foreign->Objects.equals(foreign.getFoodSubGroupCode(), mixee.getIngredientFoodOrRecipeSubgroup()))
            .orElse(null);
    }
}
