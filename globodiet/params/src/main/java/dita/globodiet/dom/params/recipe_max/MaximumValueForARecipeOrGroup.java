...
public class MaximumValueForARecipeOrGroup implements Cloneable<MaximumValueForARecipeOrGroup> {
    @Inject
    ...
    @Programmatic
    @Override
    public MaximumValueForARecipeOrGroup copy() {
        var copy = repositoryService.detachedEntity(new MaximumValueForARecipeOrGroup());
