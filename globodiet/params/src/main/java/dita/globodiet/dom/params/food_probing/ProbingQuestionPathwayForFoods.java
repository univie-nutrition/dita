...
public class ProbingQuestionPathwayForFoods implements Cloneable<ProbingQuestionPathwayForFoods> {
    @Inject
    ...
    @Programmatic
    @Override
    public ProbingQuestionPathwayForFoods copy() {
        var copy = repositoryService.detachedEntity(new ProbingQuestionPathwayForFoods());
