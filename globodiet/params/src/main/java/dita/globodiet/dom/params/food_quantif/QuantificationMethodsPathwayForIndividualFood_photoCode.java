...
public class QuantificationMethodsPathwayForIndividualFood_photoCode {
    @Inject
    RepositoryService repositoryService;

    private final QuantificationMethodsPathwayForIndividualFood mixee;

    @MemberSupport
    public PhotoForQuantity prop() {
        return repositoryService
            .uniqueMatch(PhotoForQuantity.class,
                foreign->Objects.equals(foreign.getCode(), mixee.getPhotoCode()))
            .orElse(null);
    }
}
