...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this PercentOfFatUseDuringCookingForFood",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class PercentOfFatUseDuringCookingForFood_delete {
    @Inject
    ...
    @MemberSupport
    public PercentOfFatUseDuringCookingForFood.Manager act(String dependants) {
