...
public class MixedRecipeIngredientsQuantification_ingredientFoodOrRecipeIDNumberObj {
    @Inject
    ...
    public FoodOrProductOrAlias prop() {
        return repositoryService
            .uniqueMatch(FoodOrProductOrAlias.class,
                foreign->Objects.equals(foreign.getFoodIdNumber(), mixee.getIngredientFoodOrRecipeIDNumber()))
            .orElse(null);
    }
}
