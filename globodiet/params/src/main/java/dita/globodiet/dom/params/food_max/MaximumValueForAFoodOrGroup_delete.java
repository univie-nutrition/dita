...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this MaximumValueForAFoodOrGroup",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class MaximumValueForAFoodOrGroup_delete {
    @Inject
    ...
    @MemberSupport
    public MaximumValueForAFoodOrGroup.Manager act(String dependants) {
