...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this PercentOfFatOrSauceOrSweetenerAddedAfterCookingForFood",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class PercentOfFatOrSauceOrSweetenerAddedAfterCookingForFood_delete {
    @Inject
    ...
    @MemberSupport
    public PercentOfFatOrSauceOrSweetenerAddedAfterCookingForFood.Manager act(String dependants) {
