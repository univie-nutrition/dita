...
public class MixedRecipeNames_subgroupCodeOfTheRecipeClassificationObj {
    @Inject
    ...
    public RecipeGroupOrSubgroup prop() {
        return repositoryService
            .uniqueMatch(RecipeGroupOrSubgroup.class,
                foreign->Objects.equals(foreign.getRecipeSubGroupCode(), mixee.getSubgroupCodeOfTheRecipeClassification()))
            .orElse(null);
    }
}
