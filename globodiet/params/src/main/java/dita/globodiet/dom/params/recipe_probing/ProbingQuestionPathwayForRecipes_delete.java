...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this ProbingQuestionPathwayForRecipes",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class ProbingQuestionPathwayForRecipes_delete {
    @Inject
    ...
    @MemberSupport
    public ProbingQuestionPathwayForRecipes.Manager act(String dependants) {
