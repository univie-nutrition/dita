...
public class CenterInvolved implements Cloneable<CenterInvolved>, HasSecondaryKey<CenterInvolved> {
    @Inject
    ...
    @Programmatic
    @Override
    public CenterInvolved copy() {
        var copy = repositoryService.detachedEntity(new CenterInvolved());
        copy.setCenterCode(getCenterCode());
        copy.setAttachedCountryCode(getAttachedCountryCode());
        copy.setCenterName(getCenterName());
        return copy;
    }
    ...
    public CenterInvolved.Manager getNavigableParent() {
        return new CenterInvolved.Manager(searchService, "");
    }
