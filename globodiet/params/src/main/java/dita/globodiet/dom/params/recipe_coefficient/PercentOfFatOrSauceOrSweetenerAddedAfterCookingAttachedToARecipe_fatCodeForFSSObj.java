...
public class PercentOfFatOrSauceOrSweetenerAddedAfterCookingAttachedToARecipe_fatCodeForFSSObj {
    @Inject
    ...
    public FoodOrProductOrAlias prop() {
        return repositoryService
            .uniqueMatch(FoodOrProductOrAlias.class,
                foreign->Objects.equals(foreign.getFoodIdNumber(), mixee.getFatCodeForFSS()))
            .orElse(null);
    }
}
