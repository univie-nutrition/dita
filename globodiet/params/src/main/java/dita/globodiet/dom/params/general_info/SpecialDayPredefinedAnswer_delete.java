...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this SpecialDayPredefinedAnswer",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class SpecialDayPredefinedAnswer_delete {
    @Inject
    ...
    @MemberSupport
    public SpecialDayPredefinedAnswer.Manager act(String dependants) {
