...
public class FoodStandardUnitsAndPortionsForFoodsAndRecipes_foodOrRecipeIdentificationNumber {
    @Inject
    RepositoryService repositoryService;

    private final FoodStandardUnitsAndPortionsForFoodsAndRecipes mixee;

    @MemberSupport
    public FoodOrProductOrAlias prop() {
        return repositoryService
            .uniqueMatch(FoodOrProductOrAlias.class,
                foreign->Objects.equals(foreign.getFoodIdNumber(), mixee.getFoodOrRecipeIdentificationNumber()))
            .orElse(null);
    }
}
