...
public class CrossReferenceBetweenFoodGroupAndDescriptor_foodSubgroup {
    @Inject
    ...
    public FoodSubgroup prop() {
        final var lookupKey = new FoodSubgroup.SecondaryKey(mixee.getFoodSubgroupCode(), null, null);
