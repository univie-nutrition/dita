...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this QuantificationMethodsPathwayForFood",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class QuantificationMethodsPathwayForFood_delete {
    @Inject
    ...
    @MemberSupport
    public QuantificationMethodsPathwayForFood.Manager act(String dependants) {
