...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this ExceptionToFacetsPathwayForRecipe",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class ExceptionToFacetsPathwayForRecipe_delete {
    @Inject
    ...
    @MemberSupport
    public ExceptionToFacetsPathwayForRecipe.Manager act(String dependants) {
