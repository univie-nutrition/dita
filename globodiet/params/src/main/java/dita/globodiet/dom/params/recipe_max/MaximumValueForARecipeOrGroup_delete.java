...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this MaximumValueForARecipeOrGroup",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class MaximumValueForARecipeOrGroup_delete {
    @Inject
    ...
    private final MaximumValueForARecipeOrGroup mixee;

    @MemberSupport
    public MaximumValueForARecipeOrGroup.Manager act(String dependants) {
