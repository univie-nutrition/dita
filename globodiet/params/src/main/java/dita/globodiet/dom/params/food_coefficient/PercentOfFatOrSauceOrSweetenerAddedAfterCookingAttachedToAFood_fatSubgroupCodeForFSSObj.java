...
public class PercentOfFatOrSauceOrSweetenerAddedAfterCookingAttachedToAFood_fatSubgroupCodeForFSSObj {
    @Inject
    ...
    public FoodSubgroup prop() {
        return repositoryService
            .uniqueMatch(FoodSubgroup.class,
                foreign->Objects.equals(foreign.getFoodSubGroupCode(), mixee.getFatSubgroupCodeForFSS()))
            .orElse(null);
    }
}
