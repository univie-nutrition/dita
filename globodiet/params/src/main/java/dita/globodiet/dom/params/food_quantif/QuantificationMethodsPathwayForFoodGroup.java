...
public class QuantificationMethodsPathwayForFoodGroup implements Cloneable<QuantificationMethodsPathwayForFoodGroup> {
    @Inject
    ...
    @Programmatic
    @Override
    public QuantificationMethodsPathwayForFoodGroup copy() {
        var copy = repositoryService.detachedEntity(new QuantificationMethodsPathwayForFoodGroup());
    ...
    @NotPersistent
    public QuantificationMethodsPathwayForFoodGroup.Manager getNavigableParent() {
        return new QuantificationMethodsPathwayForFoodGroup.Manager(searchService, "");
    }
