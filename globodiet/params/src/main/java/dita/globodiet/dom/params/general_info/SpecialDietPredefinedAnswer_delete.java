...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this SpecialDietPredefinedAnswer",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class SpecialDietPredefinedAnswer_delete {
    @Inject
    ...
    @MemberSupport
    public SpecialDietPredefinedAnswer.Manager act(String dependants) {
