...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this DietarySupplementDescriptor",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class DietarySupplementDescriptor_delete {
    @Inject
    ...
    @MemberSupport
    public DietarySupplementDescriptor.Manager act(String dependants) {
