...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this QuantificationMethodPathwayForRecipe",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class QuantificationMethodPathwayForRecipe_delete {
    @Inject
    ...
    @MemberSupport
    public QuantificationMethodPathwayForRecipe.Manager act(String dependants) {
