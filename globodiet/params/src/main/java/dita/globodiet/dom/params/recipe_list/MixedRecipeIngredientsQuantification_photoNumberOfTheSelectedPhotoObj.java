...
public class MixedRecipeIngredientsQuantification_photoNumberOfTheSelectedPhotoObj {
    @Inject
    ...
    public PhotoForQuantity prop() {
        return repositoryService
            .uniqueMatch(PhotoForQuantity.class,
                foreign->Objects.equals(foreign.getQuantificationStringThatDefinesTheQuantitiesOfEachPhotos(), mixee.getPhotoNumberOfTheSelectedPhoto()))
            .orElse(null);
    }
}
