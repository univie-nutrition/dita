...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this ProbingQuestionPathwayForFoods",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class ProbingQuestionPathwayForFoods_delete {
    @Inject
    ...
    @MemberSupport
    public ProbingQuestionPathwayForFoods.Manager act(String dependants) {
