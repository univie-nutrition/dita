...
public class MaximumValueForAFoodOrGroup implements Cloneable<MaximumValueForAFoodOrGroup> {
    @Inject
    ...
    @Programmatic
    @Override
    public MaximumValueForAFoodOrGroup copy() {
        var copy = repositoryService.detachedEntity(new MaximumValueForAFoodOrGroup());
    ...
    @NotPersistent
    public MaximumValueForAFoodOrGroup.Manager getNavigableParent() {
        return new MaximumValueForAFoodOrGroup.Manager(searchService, "");
    }

    /**
     * Manager Viewmodel for @{link MaximumValueForAFoodOrGroup}
     */
    @Named("dita.globodiet.params.food_max.MaximumValueForAFoodOrGroup.Manager")
    @DomainObjectLayout(
            describedAs = "Maximum value for a food or a (sub-)(sub-)group"
    )
    @AllArgsConstructor
    public static final class Manager implements ViewModel {
        ...
        @ObjectSupport
        public String title() {
            return "Manage Maximum Value For A Food Or Group";
        }

        @Collection
        public final List<MaximumValueForAFoodOrGroup> getListOfMaximumValueForAFoodOrGroup() {
            return searchService.search(MaximumValueForAFoodOrGroup.class, MaximumValueForAFoodOrGroup::title, search);
        }
