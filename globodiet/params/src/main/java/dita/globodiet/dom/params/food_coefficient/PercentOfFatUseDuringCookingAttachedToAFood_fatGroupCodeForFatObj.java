...
public class PercentOfFatUseDuringCookingAttachedToAFood_fatGroupCodeForFatObj {
    @Inject
    ...
    public FoodGroup prop() {
        return repositoryService
            .uniqueMatch(FoodGroup.class,
                foreign->Objects.equals(foreign.getFoodGroupCode(), mixee.getFatGroupCodeForFat()))
            .orElse(null);
    }
}
