...
public class ExceptionForSomeFoodToTheFacetDescriptorPathway_facetCodesThatMUSTAppearInTheSequenceOfFacetsCorrespondingToThisFood {
    @Inject
    RepositoryService repositoryService;

    private final ExceptionForSomeFoodToTheFacetDescriptorPathway mixee;

    @MemberSupport
    public Facet prop() {
        return repositoryService
            .uniqueMatch(Facet.class,
                foreign->Objects.equals(foreign.getFacetCode(), mixee.getFacetCodesThatMUSTAppearInTheSequenceOfFacetsCorrespondingToThisFood()))
            .orElse(null);
    }
}
