        ...
        return repositoryService
            .uniqueMatch(FoodSubgroup.class,
                foreign->Objects.equals(foreign.getFoodGroupCode(), mixee.getForTheFoodItemsTheFoodSubgroupsForWhichThisThicknessHasToBeProposed())
                    && Objects.equals(foreign.getFoodSubgroupCode(), mixee.getForTheFoodItemsTheFoodSubgroupsForWhichThisThicknessHasToBeProposed())
                    && Objects.equals(foreign.getFoodSubSubgroupCode(), mixee.getForTheFoodItemsTheFoodSubgroupsForWhichThisThicknessHasToBeProposed())
                )
            .orElse(null);
    }
}
