...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this StandardUnitForFoodOrRecipe",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class StandardUnitForFoodOrRecipe_delete {
    @Inject
    ...
    @MemberSupport
    public StandardUnitForFoodOrRecipe.Manager act(String dependants) {
