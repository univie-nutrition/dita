...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this FacetDescriptorPathwayForRecipe",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class FacetDescriptorPathwayForRecipe_delete {
    @Inject
    ...
    @MemberSupport
    public FacetDescriptorPathwayForRecipe.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
