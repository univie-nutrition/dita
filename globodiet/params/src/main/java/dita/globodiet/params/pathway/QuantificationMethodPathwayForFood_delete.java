...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this QuantificationMethodPathwayForFood",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class QuantificationMethodPathwayForFood_delete {
    @Inject
    ...
    @MemberSupport
    public QuantificationMethodPathwayForFood.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
