...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this PercentOfFatOrSauceOrSweetenerAddedAfterCookingForRecipe",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class PercentOfFatOrSauceOrSweetenerAddedAfterCookingForRecipe_delete {
    @Inject
    ...
    @MemberSupport
    public PercentOfFatOrSauceOrSweetenerAddedAfterCookingForRecipe.Manager act(
