...
public class NutrientValue_nutrientForFoodOrGroup {
    @Inject
    ...
    @MemberSupport
    public NutrientForFoodOrGroup prop() {
        final var lookupKey = new NutrientForFoodOrGroup.SecondaryKey(mixee.getNutrientForFoodOrGroupCode());
