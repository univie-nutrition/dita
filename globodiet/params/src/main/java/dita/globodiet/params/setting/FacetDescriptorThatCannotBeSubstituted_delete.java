...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this FacetDescriptorThatCannotBeSubstituted",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class FacetDescriptorThatCannotBeSubstituted_delete {
    @Inject
    ...
    @MemberSupport
    public FacetDescriptorThatCannotBeSubstituted.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
