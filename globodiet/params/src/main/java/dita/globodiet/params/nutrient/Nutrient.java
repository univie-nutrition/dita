...
public class Nutrient implements Persistable, Cloneable<Nutrient>, HasSecondaryKey<Nutrient> {
    ...
    @Setter
    @Convert(
            converter = DisplayInTheNutrientChecksScreen.Converter.class
    )
    ...
    public enum DisplayInTheNutrientChecksScreen implements EnumWithCode<Integer> {
        ...
        public static final class Converter implements EnumConverter<DisplayInTheNutrientChecksScreen, Integer> {
            @Override
            public DisplayInTheNutrientChecksScreen[] values() {
                return DisplayInTheNutrientChecksScreen.values();
            }
        }
    }
