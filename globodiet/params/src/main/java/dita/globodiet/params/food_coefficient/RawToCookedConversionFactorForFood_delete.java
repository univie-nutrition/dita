...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this RawToCookedConversionFactorForFood",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class RawToCookedConversionFactorForFood_delete {
    @Inject
    ...
    @MemberSupport
    public RawToCookedConversionFactorForFood.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
