...
public class Recipe implements Persistable, Cloneable<Recipe>, HasSecondaryKey<Recipe> {
    @Inject
    @Transient
    ...
    @Setter
    @Convert(
            converter = RecipeType.Converter.class
    )
    ...
    @Setter
    @Convert(
            converter = AliasQ.Converter.class
    )
    ...
    @Setter
    @Convert(
            converter = HasSubRecipeQ.Converter.class
    )
    ...
    @Setter
    @Convert(
            converter = Status.Converter.class
    )
    ...
    public enum RecipeType implements EnumWithCode<String> {
        ...
        public static final class Converter implements EnumConverter<RecipeType, String> {
            @Override
            public RecipeType[] values() {
                return RecipeType.values();
            }
        }
    }
    ...
    @RequiredArgsConstructor
    public enum AliasQ implements EnumWithCode<String> {
        ...
        @jakarta.persistence.Converter
        public static final class Converter implements EnumConverter<AliasQ, String> {
            @Override
            public AliasQ[] values() {
                return AliasQ.values();
            }
        }
    }
    ...
    @RequiredArgsConstructor
    public enum HasSubRecipeQ implements EnumWithCode<Integer> {
        ...
        @jakarta.persistence.Converter
        public static final class Converter implements EnumConverter<HasSubRecipeQ, Integer> {
            @Override
            public HasSubRecipeQ[] values() {
                return HasSubRecipeQ.values();
            }
        }
    }
    ...
    @RequiredArgsConstructor
    public enum Status implements EnumWithCode<String> {
        ...
        @jakarta.persistence.Converter
        public static final class Converter implements EnumConverter<Status, String> {
            @Override
