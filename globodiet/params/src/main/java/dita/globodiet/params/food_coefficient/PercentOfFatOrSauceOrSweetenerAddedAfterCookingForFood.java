...
public class PercentOfFatOrSauceOrSweetenerAddedAfterCookingForFood implements Persistable, Cloneable<PercentOfFatOrSauceOrSweetenerAddedAfterCookingForFood> {
    @Inject
    @Transient
