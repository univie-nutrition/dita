...
public class DensityFactorForFoodOrRecipe implements Persistable, Cloneable<DensityFactorForFoodOrRecipe> {
    @Inject
    @Transient
    ...
    @Setter
    @Convert(
            converter = ForFoodOrRecipe.Converter.class
    )
    ...
    @RequiredArgsConstructor
    public enum ForFoodOrRecipe implements EnumWithCode<Integer> {
        ...
        @jakarta.persistence.Converter
        public static final class Converter implements EnumConverter<ForFoodOrRecipe, Integer> {
            @Override
            public ForFoodOrRecipe[] values() {
                return ForFoodOrRecipe.values();
            }
        }
    }
