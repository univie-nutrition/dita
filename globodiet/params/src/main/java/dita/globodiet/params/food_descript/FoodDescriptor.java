...
public class FoodDescriptor implements Persistable, Cloneable<FoodDescriptor>, HasSecondaryKey<FoodDescriptor> {
    @Inject
    @Transient
    ...
    @Setter
    @Convert(
            converter = Cooking.Converter.class
    )
    ...
    @Setter
    @Convert(
            converter = Choice.Converter.class
    )
    ...
    public enum Cooking implements EnumWithCode<Integer> {
        ...
        public static final class Converter implements EnumConverter<Cooking, Integer> {
            @Override
            public Cooking[] values() {
    ...
    @RequiredArgsConstructor
    public enum Choice implements EnumWithCode<Integer> {
        ...
        @jakarta.persistence.Converter
        public static final class Converter implements EnumConverter<Choice, Integer> {
            @Override
