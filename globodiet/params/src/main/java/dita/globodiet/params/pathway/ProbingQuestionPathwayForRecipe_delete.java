...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this ProbingQuestionPathwayForRecipe",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class ProbingQuestionPathwayForRecipe_delete {
    @Inject
    ...
    @MemberSupport
    public ProbingQuestionPathwayForRecipe.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
