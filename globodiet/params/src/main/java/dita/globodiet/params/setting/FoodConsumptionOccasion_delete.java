...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this FoodConsumptionOccasion",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class FoodConsumptionOccasion_delete {
    @Inject
    ...
    @MemberSupport
    public FoodConsumptionOccasion.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
