...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this RecipeIngredientQuantification",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class RecipeIngredientQuantification_delete {
    @Inject
    ...
    @MemberSupport
    public RecipeIngredientQuantification.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
