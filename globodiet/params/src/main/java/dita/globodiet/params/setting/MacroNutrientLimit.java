...
public class MacroNutrientLimit implements Persistable, Cloneable<MacroNutrientLimit> {
    @Inject
    @Transient
    ...
    @RequiredArgsConstructor
    public enum Sex implements EnumWithCode<String> {
        ...
        @jakarta.persistence.Converter
        public static final class Converter implements EnumConverter<Sex, String> {
            @Override
            public Sex[] values() {
                return Sex.values();
            }
