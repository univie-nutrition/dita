...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this FacetDescriptorPathwayForFood",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class FacetDescriptorPathwayForFood_delete {
    @Inject
    ...
    @MemberSupport
    public FacetDescriptorPathwayForFood.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
