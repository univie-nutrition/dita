...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this TranslationInCountryLanguage",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class TranslationInCountryLanguage_delete {
    @Inject
    ...
    @MemberSupport
    public TranslationInCountryLanguage.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
