...
public class PercentOfFatOrSauceOrSweetenerAddedAfterCookingForRecipe_fss {
    @Inject
    ...
    @MemberSupport
    public Food prop() {
        if(mixee.getFssCode()==null) return null;
        final var lookupKey = new Food.SecondaryKey(mixee.getFssCode());
