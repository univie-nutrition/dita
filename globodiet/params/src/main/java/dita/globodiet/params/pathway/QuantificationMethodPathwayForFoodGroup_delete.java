...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this QuantificationMethodPathwayForFoodGroup",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class QuantificationMethodPathwayForFoodGroup_delete {
    @Inject
    ...
    @MemberSupport
    public QuantificationMethodPathwayForFoodGroup.Manager act(
