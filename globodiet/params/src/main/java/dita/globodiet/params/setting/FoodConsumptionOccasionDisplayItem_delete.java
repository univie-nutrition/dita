...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this FoodConsumptionOccasionDisplayItem",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class FoodConsumptionOccasionDisplayItem_delete {
    @Inject
    ...
    @MemberSupport
    public FoodConsumptionOccasionDisplayItem.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
