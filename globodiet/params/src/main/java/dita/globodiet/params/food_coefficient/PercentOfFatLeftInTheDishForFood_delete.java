...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this PercentOfFatLeftInTheDishForFood",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class PercentOfFatLeftInTheDishForFood_delete {
    @Inject
    ...
    @MemberSupport
    public PercentOfFatLeftInTheDishForFood.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
