...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this FacetDescriptorPathwayForFoodGroup",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class FacetDescriptorPathwayForFoodGroup_delete {
    @Inject
    ...
    @MemberSupport
    public FacetDescriptorPathwayForFoodGroup.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
