...
@ActionLayout(
        fieldSetId = "details",
        sequence = "9",
        describedAs = "Delete this MaximumValueForFoodOrGroup",
        position = ActionLayout.Position.PANEL
)
@RequiredArgsConstructor
public class MaximumValueForFoodOrGroup_delete {
    @Inject
    ...
    @MemberSupport
    public MaximumValueForFoodOrGroup.Manager act(@ParameterLayout(labelPosition = LabelPosition.TOP, multiLine = 12) String dependants) {
